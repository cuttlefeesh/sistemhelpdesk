...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 min-h-screen sidebar-gradient flex flex-col shadow-[4px_0_16px_rgba(0,0,0,0.18)]">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        ...
        <div>
          <p className="text-white text-[13px] font-bold leading-tight tracking-wide">{adminName}</p>
