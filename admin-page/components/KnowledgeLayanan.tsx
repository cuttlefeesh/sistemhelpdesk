  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#e8edf5] overflow-hidden">
        ...
        {/* Pengingat cek duplikasi konten */}
        <div className="flex items-start gap-3 bg-amber-50 border-t border-amber-200 text-amber-800 text-sm px-3 py-3 md:px-6">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0 text-amber-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
          </svg>
          <p>
            Periksa kembali entri yang baru ditambahkan atau diperbarui — pastikan Nama Intent, Deskripsi &amp; Prosedur tidak sama atau mirip dengan entri lain yang sudah ada di Daftar Knowledge agar tidak terjadi duplikasi data.
          </p>
        </div>
