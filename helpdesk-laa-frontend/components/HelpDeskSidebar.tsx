  ...
  return (
    ...
    >
      <div className="flex flex-col h-full overflow-hidden">
        ...
        {/* Footer */}
        <div className="relative p-6 border-t border-gray-100 bg-white flex items-center justify-between gap-2">
          <div>
          ...
          <div className="relative">
            ...
            {showSettingsMenu && (
              <div className="absolute right-0 bottom-full mb-2 w-36 bg-white rounded-lg shadow-xl border border-gray-100 z-[999] overflow-hidden">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setShowSettingsMenu(false);
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 flex items-center gap-2 transition border-t border-gray-100"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
